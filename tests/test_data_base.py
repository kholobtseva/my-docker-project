...
class TestPostgreSQLCICD:
    ...
    def test_crud_operations(self, db_connection, db_cursor):
        ...
        with allure.step("Test SELECT operations"):
            ...
            assert count > 0  # В init.sql есть данные
    ...
    def test_query_performance(self, db_cursor):
        ...
        with allure.step("Test basic query performance"):
            ...
            assert execution_time < 5.0, f"Query too slow: {execution_time} seconds"
