...
- ✅ Юнит-тесты (pytest) — стартовое покрытие уже реализовано.
- 🔄 Интеграционные тесты (Kafka ↔ PostgreSQL ↔ Elasticsearch).
- 🔄 E2E тесты пайплайна «от источника до выгрузки».
- 🔄 Нагрузочное тестирование (Kafka, PostgreSQL).
- 🔄 Расширение отчётности и визуализации результатов тестов.
